...
//           <Link to="/jharkhand/ranchi" className="bg-pink-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-pink-700 transition-colors">
//             Back to Ranchi
//           </Link>
//         </div>
//       </div>
...
//       state: 'Jharkhand',
//     });
//     navigate('/jharkhand/ranchi/booking');
//   };
...
//           <span className="mx-2">›</span>
//           <Link to="/jharkhand/ranchi" className="hover:underline">Ranchi</Link>
//           <span className="mx-2">›</span>
...
//               <LazyImage
//                 src={service.image}
//                 alt={`${service.name} in Ranchi, Jharkhand`}
