...
const HaldwaniServiceDetail = () => {
    ...
    return (
      <div className="min-h-screen bg-neutral-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <Link to="/uttarakhand/haldwani" className="bg-pink-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-pink-700 transition-colors">
            Back to Haldwani
          </Link>
        </div>
      </div>
  ...
  const handleBookNow = () => {
    ...
    navigate('/uttarakhand/haldwani/booking');
  };
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="container mx-auto px-4 pt-4">
        <nav className="text-sm text-neutral-500 mb-4">
          ...
          <Link to="/uttarakhand" className="hover:underline">Uttarakhand</Link>
          <span className="mx-2">›</span>
          <Link to="/uttarakhand/haldwani" className="hover:underline">Haldwani</Link>
          <span className="mx-2">›</span>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
          <div className="md:flex">
            ...
            <div className="md:w-1/2">
              <LazyImage
                src={service.image}
                alt={`${service.name} in Haldwani, Uttarakhand`}
              ...
              <div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    ...
                    100% Verified Haldwani Profiles
                  </div>
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
