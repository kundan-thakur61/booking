...
import { services } from '../../data/Goa/LajpatNagarservices';
    ...
    <div className="min-h-screen bg-neutral-50 pb-24">
      ...
      <div className="container mx-auto px-4 pt-4">
        <nav className="text-sm text-neutral-500 mb-4 flex items-center gap-1 flex-wrap">
          ...
          <span>›</span>
          <Link to="/goa/lajpat-nagar" className="hover:text-pink-600 transition-colors">LajpatNagar</Link>
          <span>›</span>
          ...
          <section className="mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {relatedServices.map((s) => (
                <Link
                  key={s.id}
                  to={`/goa/lajpat-nagar/service/${s.id}`}
