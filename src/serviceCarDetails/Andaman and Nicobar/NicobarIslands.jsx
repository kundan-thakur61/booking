      ...
      <div className="min-h-screen bg-neutral-50 pb-24">
        ...
        <div className="w-full px-0  sm:px-4 pt-4">
          <nav className="text-sm text-neutral-500 mb-4 flex items-center gap-1 flex-wrap">
            ...
            <span>›</span>
            <Link to="/andaman-and-nicobar" className="hover:text-pink-600 transition-colors">Andaman and Nicobar</Link>
            <span>›</span>
            <Link to="/andaman-and-nicobar/nicobar-islands" className="hover:text-pink-600 transition-colors">Nicobar Islands</Link>
            <span>›</span>
