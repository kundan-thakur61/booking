      ...
      return (
        <div className="min-h-screen bg-neutral-50">
          ...
          <div className="w-full px-0  sm:px-6 py-16 text-center">
            ...
            <Link
              to="/andamanand-nicobar/andaman-islands"
      ...
      <div className="min-h-screen bg-neutral-50 pb-24">
        ...
        <div className="w-full px-0  sm:px-4 pt-4">
          <nav className="text-sm text-neutral-500 mb-4 flex items-center gap-1 flex-wrap">
            ...
            <span>›</span>
            <Link to="/andamanand-nicobar/andaman-islands" className="hover:text-pink-600 transition-colors">Andaman Islands</Link>
            <span>›</span>
        ...
        <div className="w-full px-1 py-8 sm:px-6 sm:py-12">
            ...
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-6 md:p-8 flex flex-col gap-4">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-neutral-900 leading-tight">
                  {service.description}
                  <span className="text-pink-600"> in Andaman Islands</span>
                </h1>
          ...
          {relatedServices.length > 0 && (
            <section className="mt-10">
              <h2 className="text-2xl font-bold text-neutral-900 mb-5">More Services in Andaman Islands</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {relatedServices.map((s) => (
                  <Link
                    key={s.id}
                    to={`/andamanand-nicobar/andaman-islands/service/${s.id}`}
