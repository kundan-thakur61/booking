...
const Jaipur = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <SEO
        title="Escorts in Jaipur — Verified Companions & Discreet Booking | BookEase"
        description="Browse 150+ verified companion profiles in Jaipur (C-Scheme, Vaishali Nagar, Malviya Nagar). Discreet, safe, and professional bookings."
