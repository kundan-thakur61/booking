...
const Mumbai = () => {
  ...
  const cityFAQs = [
    {
      question: "Are the escort profiles in Mumbai verified?",
      answer: "Yes, all profiles on our platform are verified with ID proof and authentic photos. We conduct thorough background checks to ensure safety and authenticity for all Mumbai bookings."
    },
    {
      question: "What areas do you cover in Mumbai?",
      answer: "We cover all major areas of Mumbai including Andheri, Bandra, Juhu, Powai, Lower Parel, Worli, Colaba, and many more. Our companions are available across the city 24/7."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely. Your privacy is our top priority. All bookings are handled with complete confidentiality, and our companions are professional and discreet throughout Mumbai."
    },
    {
      question: "What are the rates for escorts in Mumbai?",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="prose prose-lg max-w-none mb-12 bg-white rounded-2xl p-8">
          ...
          <ul>
            ...
            <li><strong>Wide Selection:</strong> 500+ verified profiles across Mumbai</li>
          ...
          <p>Our Mumbai companions offer a wide range of services including:</p>
          <ul>
          ...
          <p>
            We serve all major areas of Mumbai including: Andheri East & West, Bandra, Juhu, Powai, 
            Lower Parel, Worli, Colaba, Fort, Churchgate, Marine Drive, Malabar Hill, Versova, 
            Goregaon, Malad, Kandivali, Borivali, Vile Parle, Santacruz, Khar, Dadar, Parel, and Mumbai Central.
          </p>
