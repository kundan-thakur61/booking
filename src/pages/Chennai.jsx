...
//   const popularAreas = [
//     { name: "T. Nagar", slug: "t-nagar", count: 120 },
//     { name: "Anna Nagar", slug: "anna-nagar", count: 110 },
//     { name: "Adyar", slug: "adyar", count: 90 },
//     { name: "Velachery", slug: "velachery", count: 85 },
//     { name: "Nungambakkam", slug: "nungambakkam", count: 80 },
//     { name: "OMR", slug: "omr", count: 75 },
//     { name: "ECR", slug: "ecr", count: 60 },
//     { name: "Mylapore", slug: "mylapore", count: 55 },
//   ];

//   const localBusinessSchema = {
//     "@context": "https://schema.org",
//     "@type": "AdultEntertainment",
//     "name": "BookEase Chennai Escorts",
//     "description": "Verified escort and companion services in Chennai with 200+ profiles across T. Nagar, Anna Nagar, Adyar and more areas",
//     "priceRange": "₹₹₹",
//     "address": {
//       "@type": "PostalAddress",
...
//       "closes": "23:59"
//     },
//     "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.6", "reviewCount": "178", "bestRating": "5", "worstRating": "1" }
//   };
...
//       { "@type": "ListItem", "position": 2, "name": "Chennai", "item": "https://www.escortmumbaii.in/chennai" }
//     ]
//   };
...
//       <SEO
//         title="Escorts in Chennai — Verified Companions & Discreet Booking | BookEase"
//         description="Browse 200+ verified companion profiles in Chennai (T. Nagar, Anna Nagar, Adyar). Discreet, safe, and professional bookings with verified providers."
...
//             <span>Chennai</span>
//           </nav>
//           <h1 className="text-4xl md:text-5xl font-bold mb-4">Escorts & Companions in Chennai</h1>
//           <p className="text-xl mb-6 max-w-3xl">
//             Browse 200+ verified profiles of premium escorts and independent companions available 24/7 across all areas of Chennai.
//           </p>
...
//           <h2 className="text-3xl font-bold text-neutral-900 mb-6">Popular Areas in Chennai</h2>
...
//         <section className="mb-12">
//           <h2 className="text-3xl font-bold text-neutral-900 mb-6">Available Services in Chennai</h2>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//             {chennaiServices.map((service) => (
...
//           <p>Chennai, the cultural capital of South India, offers a refined adult entertainment scene. Our platform connects you with verified, professional escorts and companions across all major areas.</p>
