...
const __CITY_NAME__ServiceDetail = () => {
    ...
    return (
      <div className="min-h-screen bg-neutral-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <Link to="/__STATE_SLUG__/__CITY_SLUG__" className="bg-pink-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-pink-700 transition-colors">
            Back to __CITY_DISPLAY__
          </Link>
        </div>
      </div>
    );
  ...
  const handleBookNow = () => {
    ...
    trackEvent('begin_checkout', {
      ...
      state: '__STATE_DISPLAY__',
    });
    navigate('/__STATE_SLUG__/__CITY_SLUG__/booking');
  };
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="container mx-auto px-4 pt-4">
        <nav className="text-sm text-neutral-500 mb-4">
          ...
          <Link to="/__STATE_SLUG__" className="hover:underline">__STATE_DISPLAY__</Link>
          <span className="mx-2">›</span>
          <Link to="/__STATE_SLUG__/__CITY_SLUG__" className="hover:underline">__CITY_DISPLAY__</Link>
          <span className="mx-2">›</span>
            ...
            <div className="md:w-1/2 flex flex-col">
              ...
              <div className="relative group">
                <LazyImage
                  ...
                  alt={`${service.name} in __CITY_DISPLAY__, __STATE_DISPLAY__ - Photo ${selectedImg + 1}`}
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="bg-pink-100 text-pink-700 text-xs font-semibold px-3 py-1 rounded-full">
                    __CITY_DISPLAY__, __STATE_DISPLAY__
                  </span>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    ...
                    100% Verified __CITY_DISPLAY__ Profiles
                  </div>
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                  ...
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    ...
                    24/7 __CITY_DISPLAY__ Area Support
                  </div>
                  <div className="flex items-center gap-3 text-sm text-neutral-700">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
      ...
      {relatedServices.length > 0 && (
        <div className="container mx-auto px-4 pb-12">
          <h2 className="text-2xl font-bold text-neutral-900 mb-6">
            More Services in __CITY_DISPLAY__
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedServices.map((s) => (
              <Link
                key={s.id}
                to={`/__STATE_SLUG__/__CITY_SLUG__/service/${s.id}`}
...
export default __CITY_NAME__ServiceDetail;
