...
for (const stateDir of stateDirs) {
  ...
  //   // ── FIX Issue 5: Rewrite data file with correct city data ──
    ...
    if (fs.existsSync(cityPagePath)) {
      const newCityJsx = buildCityPageJsx(
        stateDir,
        cityFile,
        stateLabel,
        cityLabel,
      ...
      console.log(
        `  [JSX]  Fixed: serviceCarDetails/${stateDir}/${cityFile}.jsx`,
      );
      jsxFixed++;
    }
    ...
    //   console.log(
    //     `  [JSX]  Fixed: serviceCarDetails/${stateDir}/${cityFile}servicesDetails.jsx`,
    //   );
    //   jsxFixed++;
    // }
  }
